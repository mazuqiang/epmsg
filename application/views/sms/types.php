...
<div id="body-wrapper">
	...
	var answer = confirm("极其不推荐这么做！\n确实要删除该类型吗？")
	if (answer){
	    window.location.href="<?php echo(site_url('sms/types/dodeltype'));?>/"+type_id; 
	}
	else{
		return false;
	}
				...
				<div class="content-box-content">
					<div class="tab-content default-tab" id="tab1" style="width: 840px;">
						...
						<p>
							...
							<input class="button" onClick="location.href='<?php echo(site_url('sms/types/addtype'));?>'" type="button" value="添加新类型" />
						</p>
